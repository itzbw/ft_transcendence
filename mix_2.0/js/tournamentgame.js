...
function loadGameTournament(leftPlayer, rightPlayer) {
    ...
    leftScoreElement.innerHTML = `${leftPlayer} : 0`;
    ...
    rightScoreElement.innerHTML = `${rightPlayer} : 0`;
    ...
    function animate() {
        ...
        function showNextMatch() {
            return "<br/> <button onmousedown='loadNextMatch(); '> Next Match</button > ";
        }
        ...
        function onGoal() {
            ...
            if (leftWon || rightWon) {
                ...
                winnerElement.innerHTML = `${leftWon ? leftPlayer : rightPlayer}  Wins!`;
...
let rightPlayerIndex = leftPlayerIndex + 1;
...
window.loadNextMatch = function () {
    ...
    console.log("nextmatchLeft:" + players[nexLeftMatchPlayer]);
    console.log("nextmatchright:" + players[nextRightMatchPlayer]);
    console.log("nextRightMacthPlayer:" + nextRightMatchPlayer);
}
